...
WEIGHTS_FILE = '/media/data2/wrye/gittemp/global_wheat_detection/fasterrcnn_resnet50_fpn_30-2020-05-13-08-36-29.pth'
...
def train(args,model,device,test_df):
    ...
    train_dataset = WheatDataset(DIR_INPUT, test_df, get_train_transform())
